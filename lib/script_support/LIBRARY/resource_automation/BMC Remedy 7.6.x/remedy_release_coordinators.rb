...
#   name: Coordinator Group Company
#   type: in-external-single-select
#   external_resource: remedy_release_coordinator_group_companies
#   required: yes
# coordinator_group_organization:
#   name: Coordinator Group Organization
#   type: in-external-single-select
#   external_resource: remedy_release_coordinator_group_organizations
#   required: yes
# coordinator_group:
#   name: Coordinator Group
#   type: in-external-single-select
#   external_resource: remedy_release_coordinator_groups
#   required: yes
###
...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    qualification = "('Company' = \"#{script_params['coordinator_group_company']}\") AND ('Support Organization' = \"#{script_params['coordinator_group_organization']}\") AND ('Support Group Name' = \"#{script_params['coordinator_group']}\") AND ('Status-SGP' = \"Enabled\") AND ('Status-SGR' = \"Enabled\") AND ('Assignment Availability' = \"Yes\") AND (('FunctionalRole' = \"Release Manager\") OR ('FunctionalRole' = \"Release Coordinator\"))"
    field = 'Login ID'
    namespaces = {
