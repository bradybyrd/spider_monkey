...
#   name: Categorization Tier 1
#   type: in-external-single-select
#   external_resource: remedy_categorization_tier1
#   required: yes
# categorization_tier2:
#   name: Categorization Tier 2
#   type: in-external-single-select
#   external_resource: remedy_categorization_tier2
#   required: yes   
###
...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    schema_name = 'CFG:Service Catalog LookUp'
    qualification = "('Status-CAT' = \"Enabled\") AND ('Status-CTA' = \"Enabled\") AND (('Company' = \"#{script_params['company']}\") OR ('Company' = \"- Global -\")) AND ('Categorization Tier 1' = \"#{script_params['categorization_tier1']}\") AND ('Categorization Tier 2' = \"#{script_params['categorization_tier2']}\") AND ('Change Management Selection' = \"Yes\") AND ('Infra Change Selection' = \"Yes\") AND ('Categorization Tier 3' != $NULL$)"
    field = 'Categorization Tier 3'
    namespaces = {
