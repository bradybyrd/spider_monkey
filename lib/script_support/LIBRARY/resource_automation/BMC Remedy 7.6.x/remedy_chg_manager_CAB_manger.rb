...
#   type: in-external-single-select
#   external_resource: remedy_chg_manager_support_organizations
#   required: yes
# support_group:
#   name: Support Group
#   type: in-external-single-select
#   external_resource: remedy_chg_manager_support_groups
#   required: yes   
###
...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    qualification = "('Company' = \"#{script_params['company']}\") AND ('Support Organization' = \"#{script_params['support_organization']}\") AND ('Support Group Name' = \"#{script_params['support_group']}\") AND ('Status-SGP' = \"Enabled\") AND ('Status-SGR' = \"Enabled\") AND ('FunctionalRole' = \"CAB-Manager\") AND ('Assignment Availability' = \"Yes\")"
    field = 'Login ID'
    namespaces = {
