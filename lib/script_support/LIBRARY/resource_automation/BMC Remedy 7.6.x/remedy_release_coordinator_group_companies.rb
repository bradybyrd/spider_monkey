...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    qualification = "(('FunctionalRole' = \"Release Coordinator\") OR ('FunctionalRole' = \"Release Manager\")) AND ('Assignment Availability' = \"Yes\") AND ('Status-SGR' = \"Enabled\") AND ('Status-SGP' = \"Enabled\")"
    field = 'Company'
    namespaces = {
