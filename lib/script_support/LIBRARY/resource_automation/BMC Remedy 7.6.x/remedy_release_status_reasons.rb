...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    schema_name = 'SYS:Status Reason Menu Items'
    qualification = "('Form Name' = \"RMS:Release\") AND ('Status' = \"Enabled\") AND ('Menu Visible' = \"Yes\") AND ('Selection Field Value' = #{script_params["status"]})"
    field = 'Status Reason Menu Item'
    namespaces = {
