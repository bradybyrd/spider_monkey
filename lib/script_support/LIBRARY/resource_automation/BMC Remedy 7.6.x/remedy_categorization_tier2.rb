...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    qualification = "('Status-CAT' = \"Enabled\") AND ('Status-CTA' = \"Enabled\") AND (('Company' = \"#{script_params['company']}\") OR ('Company' = \"- Global -\")) AND ('Categorization Tier 1' = \"#{script_params['categorization_tier1']}\") AND ('Change Management Selection' = \"Yes\") AND ('Infra Change Selection' = \"Yes\") AND ('Categorization Tier 2' != $NULL$)"
    field = 'Categorization Tier 2'
    namespaces = {
