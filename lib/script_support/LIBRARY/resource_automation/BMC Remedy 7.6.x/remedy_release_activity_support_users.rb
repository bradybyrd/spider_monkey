...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    schema_name = 'CTM:Support Group Assoc LookUp'
    qualification = "('Company' = \"#{script_params['assignee_company']}\") AND ('Support Organization' = \"#{script_params['assignee_organization']}\") AND ('Support Group Name' = \"#{script_params['assignee_group']}\") AND ('Assignment Availability' = \"Yes\")"
    namespaces = {
