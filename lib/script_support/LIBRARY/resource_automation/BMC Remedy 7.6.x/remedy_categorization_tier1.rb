...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    qualification = "('Status-CAT' = \"Enabled\") AND ('Status-CTA' = \"Enabled\") AND (('Company' = \"#{script_params['company']}\") OR ('Company' = \"- Global -\")) AND ('Change Management Selection' = \"Yes\") AND ('Infra Change Selection' = \"Yes\")"
    field = 'Categorization Tier 1'
    namespaces = {
