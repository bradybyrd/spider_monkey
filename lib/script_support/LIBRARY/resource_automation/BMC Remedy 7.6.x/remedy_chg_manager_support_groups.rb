...
def execute(script_params, parent_id, offset, max_records)
  begin
    ...
    schema_name = 'CTM:Support Group'
    qualification = "('Company' = \"#{script_params['company']}\") AND ('Support Organization' = \"#{script_params['support_organization']}\")  AND ('Status' = \"Enabled\")"
