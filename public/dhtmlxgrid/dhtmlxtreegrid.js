   ...
   eXcell_tree.prototype.setValueA = function(content){
	...
	eXcell_tree.prototype.setValue = function(valAr){
		...
		if ((this.grid._tgc.imgURL==null)||(this.grid._tgc.imgURL!=this.grid.imgURL)){
			...
			_tgc.start="<div class='treegrid_cell' style='overflow:hidden; white-space : normal;'>";
//			_tgc.start="<div class='treegrid_cell' style='overflow:hidden; white-space : nowrap; height:"+(_isIE?20:18)+"px;'>";

			_tgc.itemim="' align='absmiddle' "+(this.grid._img_height?(" height=\""+this.grid._img_height+"\""):"")+(this.grid._img_width?(" width=\""+this.grid._img_width+"\""):"")+" ><span "+((_isFF||_isOpera)?"style='display:block; margin-left:40px; margin-top:-18px; position:relative; '":"")+"id='nodeval'>";
