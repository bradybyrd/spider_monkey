...
describe ConstraintsController, :type => :controller do
  ...
  context "#create" do
    ...
    context "success" do
      ...
      it "redirects to plan route path" do
        post :create, @params
        response.should redirect_to(plan_plan_route_path(@plan_route.plan, @plan_route))
      end
    end
    ...
    context "fails" do
      ...
      it "shows validation errors" do
        xhr :post, :create, @params
        response.should render_template('error_messages_for')
      end
  ...
  it "#update" do
    ...
    @constraint.reload
    @constraint.constrainable_type.should eql('RouteGate')
  ...
  it "#destroy" do
    ...
    response.should redirect_to(plan_plan_route_path(@plan_route.plan_id, @plan_route))
  end
end
