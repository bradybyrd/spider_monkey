...
describe ActivitiesController, :type => :controller do
  ...
  it "index" do
    get :index
    response.should redirect_to(request_projects_path)
  end
  ...
  context "#request_projects" do
    it "render action" do
      ...
      @activities[0..24].each{|el| assigns(:activities).should include(el)}
      assigns(:activities).should_not include(@activities[25])
      response.should render_template('request_projects')
    end

    it "render partial" do
      xhr :get, :request_projects
      response.should render_template(:partial => "activities/_request_projects")
    end
  end
  ...
  context "#create" do
    it "success, returns flash and redirect" do
      ...
      response.should redirect_to(activity_category_path(@activity.activity_category))
    end
    ...
    it "fails and render action new" do
      ...
      post :create, {:activity => {:activity_category_id => @activity_category.id,
                                   :health => ''}}
      response.should render_template(:controller => 'activities', :action => :new)
    end
  end
  ...
  context "#update" do
    ...
    it "success and redirect to activity edit path" do
      ...
      response.should redirect_to(edit_activity_path(@activity, :activity_tab_id => @activity_tab.id))
    end
  ...
  it "#creation_attributes" do
    ...
    response.should render_template(:partial => '_creation_attributes')
  end
  ...
  context "deliverable" do
    ...
    it "create" do
      ...
      response.should render_template('activities/widgets/deliverables/modify_deliverable')
    end
    ...
    context "save" do
      it "success" do
        ...
        response.should render_template('activities/widgets/deliverables/save_deliverable')
      end
      ...
      it "returns errors" do
        ...
        post :save_deliverable, {:id => @activity.id,
                                 ...
                                 :activity_deliverable => {:projected_delivery_on => '11/17/2013',
                                                           :delivered_on => '11/17/2013'}}
        response.should render_template('activities/widgets/deliverables/invalid_deliverable')
      end
    end
  ...
  it "#load_requests" do
    ...
    response.should render_template(:partial => "plans/release_calendar/_requests")
  end
end
