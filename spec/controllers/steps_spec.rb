...
describe StepsController, :type => :controller do
  ...
  context "#index" do
    specify "completed request" do
      ...
      get :index, {:request_id => @request_id}
      response.should render_template("steps/request_complete")
    end
    ...
    context "not completed request" do
      ...
      it "renders template 'steps/index'" do
        ...
        @step1.all_done!
        @step1.reload
        @step1.aasm_state.should eql('complete')
        get :index, {:request_id => @request_id,
                     :unfolded_steps => "#{@step2.id}",
                     :format => 'js'}
        response.should render_template('steps/index')
      end
  ...
  it "#get_section" do
    get :get_section, {:request_id => @request_id,
                       :id => @step1.id}
    response.should render_template(:partial => 'steps/step_rows/_step_show_form')
  end
  ...
  context "#currently_running" do
    ...
    it "returns page path should_user_include_groups=true" do
      ...
      assigns(:page_path).should include("should_user_include_groups=true")
    end

    it "returns page path dashboard_currently_running_url" do
      get :currently_running
      response.should render_template('steps/currently_running')
    end
  end
  ...
  context "#update_components" do
    ...
    it "deletes steps" do
      ...
      expect{get :update_components, {:steps => [@step1.id],
                                      :components => {"#{@step1.id}" => ''},
  ...
  describe '#new' do
    ...
    it "#new" do
      get :new, {:request_id => @request_id,
                 :parallel => true}
      response.should render_template(:partial => 'steps/step_rows/_step_form')
    end
  end
  ...
  describe '#load_tab_data' do
    context 'not authorized' do
      ...
      it 'redirects to root path' do
        get :load_tab_data, request_id: @request_id, li_id: 'st_documents'
    ...
    it "renders template" do
      get :load_tab_data, {:id => @step1.id,
                           ...
                           :li_id => 'st_documents',
                           :format => 'js'}
      response.should render_template('load_tab_data')
    end
  end
  ...
  describe "#references_for_request" do
    ...
    context "step creation" do
      ...
      it "should return package references in content tab" do
        ...
        reference = package.references.create({server_id: 1, uri: "abcd", name: "test"})
  ...
  describe "#new_step_for_procedure" do
    ...
    context 'not authorized' do
      ...
      it 'redirects to root path' do
        get :new_step_for_procedure, request_id: @request_id
        expect(response).to redirect_to root_path
      end
    end
    ...
    context 'authorized' do
      ...
      it 'succeeds' do
        get :new_step_for_procedure, request_id: @request_id, procedure_id: procedure.id
    ...
    it "renders template" do
      ...
      get :new_step_for_procedure, {:procedure_id => @procedure.id,
                                    :parallel => true}
      response.should render_template(:partial => 'steps/step_rows/_new_step_for_procedure_form')
    end
  end
  ...
  context "#create" do
    ...
    context "limit versions true" do
      ...
      it 'fails and redirects to edit request path' do
        ...
        assigns(:validation_errors).should be_truthy
        response.should redirect_to(edit_request_path(@request1) + "#step_#{@step1.id}_#{@step1.position}_heading")
      end
      ...
      it "success" do
        ...
        expect{post :create, {:request_id => @request_id,
                              :step => {:component_id => @component.id,
    ...
    it "renders partial ajax file submit" do
      ...
      post :create, {:request_id => @request_id,
                     :step => {:component_id => @component.id,
                               ...
                               :should_execute => true},
                     :ajax_request => true}
      response.should render_template(:partial => 'steps/step_rows/_ajax_file_submit')
    end
  end
  ...
  it "#create_procedure_step" do
    ...
    @procedure = create(:procedure)
    expect{
    post :create_procedure_step, {:request_id => @request_id,
                                  :step => {:component_id => @component.id,
                                            :version => "2",
                                            :name => "Step name1",
                                            :manual => true,
  ...
  it "#show" do
    get :show, {:request_id => @request_id, :id => @step1.id}
    response.should render_template(:partial => 'steps/step_rows/_step_header')
  end

  it "#edit" do
    get :edit, {:request_id => @request_id, :id => @step1.id}
    response.should render_template(:partial => 'steps/step_rows/_step_form')
  end
  ...
  describe "#edit_step_in_procedure" do
    it 'renders procedure step template' do
      @procedure = create(:procedure)
      @procedure.apps << @app
      get :edit_step_in_procedure, {request_id: @request_id,
                                    id: @step1.id,
                                    procedure_id: @procedure.id}
      response.should render_template(partial: 'steps/step_rows/_procedure_step_form')
  ...
  context "#update_position" do
    ...
    it "renders partial procedure for reorder" do
      put :update_position, {:request_id => @request_id,
                             :id => @step1.id,
                             :procedure_step => {:insertion_point => 2}}
      @step1.reload
      @step1.insertion_point.should eql(2)
    ...
    it "renders partial step for reorder" do
      ...
      @step2.reload
      @step2.insertion_point.should eql(1)
      response.should render_template(:partial => 'steps/_step_for_reorder')
    end
  end
  ...
  context "#update" do
    ...
    context "mutually exclusive package and component" do
      ...
      it "removes component if package is selected" do
        ...
        @mutual_step.save
        request_hash = {request_id: @request_id,
                        id: @mutual_step.id,
    ...
    context "property value" do
      ...
      it "fails and redirects to edit request path" do
        ...
        @version_tag = create(:version_tag)
        put :update, {:request_id => @request_id,
                       :id => @step1.id,
                       :step => {:component_id => @component.id,
                                 :version => @version_tag.id}}
        response.should render_template('misc/error_messages_for')
    ...
    context "package with params arguments" do
      ...
      it "success with argument params" do
        ...
        @step1.reload
        expect(@step1.script_id).to eql(@script.id)
      end
    end
    ...
    it "deletes server associations and renders partial steps" do
      ...
      response.should render_template(:partial => 'requests/_steps')
      @step1.reload
      @step1.server_ids.should eql([])
      @step1.server_aspect_ids.should eql([])
    end
  end
  ...
  describe "#update_procedure_step" do
    it 'updates name' do
      ...
      @step1.reload
      @step1.name.should eql("name_changed")
    end
  ...
  context "#update_uploads" do
    it "renders partial" do
      ...
      @step1.reload
      @step1.name.should eql("name_changed")
      response.should render_template(:partial => '_ajax_documents_upload_form')
    end
  ...
  context "#update_script" do
    ...
    xit "BladelogicScript" do
      ...
      put :update_script, {:request_id => @request_id,
                           :id => @step1.id,
                           ...
                           "script_id" => @script.id}
      response.should render_template(:partial => 'steps/bladelogic/_step_script')
    end
  ...
  describe '#get_package_instances' do
    ...
    it 'has create_new selected' do
      ...
      @step1.save
      get :get_package_instances, {request_id: @request_id,
                              step_id: @step1.id,
                              package: @package.id}
  ...
  describe '#update_procedure' do
    context 'not authorized' do
      ...
      it 'redirects to root path' do
        put :update_procedure, {:request_id => @request_id,
                              :id => @step1.id,
    ...
    it "renders template" do
      put :update_procedure, {:request_id => @request_id,
                              ...
                              :format => 'js'}
      @step1.reload
      @step1.name.should eql("Procedure_name_changed")
      response.should render_template('update_procedure')
    end
  end


  it "#update_should_execute" do
    put :update_should_execute, {:request_id => @request_id,
                                 :id => @step1.id,
                                 :step => {:should_execute => true},
                                 :format => 'js'}
    @step1.reload
    @step1.should_execute.should eql(true)
  end

  describe "#change_step_status" do
    it 'changes should_execute field value' do
      put :change_step_status, {request_id: @request_id,
                                id: @step1.id,
                                step: {should_execute: true},
                                format: 'js'}
      @step1.reload
  ...
  it "#update_runtime_phase" do
    ...
    put :update_runtime_phase, {:request_id => @request_id,
                                :id => @step1.id,
  ...
  it "#update_completion_state" do
    put :update_completion_state, {:request_id => @request_id,
                                   :id => @step1.id,
                                   :step => {:completion_state => 'changed'},
                                   :format => 'js'}
    @step1.reload
    @step1.completion_state.should eql('changed')
  end
  ...
  describe '#new_procedure_step' do
    context 'not authorized' do
      ...
      it 'redirects' do
        xhr :get, :new_procedure_step, {:request_id => @request_id,
                                      :id => @step1.id,
  ...
  context "#update_status" do
    ...
    it "creates note with xhr" do
      expect {xhr :put, :update_status, {:request_id => @request_id,
                                 :property_values => "",
                                 :id => @step1.id,
                                 :step => {},
                                 :note => "note",
    ...
    it "redirects to " do
      put :update_status, {:request_id => @request_id,
                           :property_values => "",
                           :id => @step1.id,
                           :step => {},
                           'start.x' => true}
      response.should redirect_to(edit_request_path(@request1, :unfolded_steps => nil))
    end
    ...
    it "starts" do
      put :update_status, {:request_id => @request_id,
                           ...
                           'start.x' => true}
      @step1.reload
      @step1.aasm_state.should eql('in_process')
    end
    ...
    it "problem" do
      ...
      put :update_status, {:request_id => @request_id,
                           ...
                           'problem.x' => true}
      @step1.reload
      @step1.aasm_state.should eql('problem')
    end
    ...
    it "block" do
      ...
      put :update_status, {:request_id => @request_id,
                           ...
                           'block.x' => true}
      @step1.reload
      @step1.aasm_state.should eql('blocked')
    end
  ...
  context "#add_note" do
    context 'not authorized' do
      ...
      it 'redirects to root path' do
        post :add_note, {:id => @step1.id, :request_id => @request_id, :note => "note"}
    ...
    it "success" do
      expect{post :add_note, {:id => @step1.id,
                              :request_id => @request_id,
                              :note => "note"}
            }.to change(@step1.notes, :count).by(1)
      response.should render_template(:partial => "steps/_step_notes_values")
    end
  ...
  describe "#destroy" do
    context 'not authorized' do
      ...
      it 'redirects to root path' do
        delete :destroy, {:id => @step1.id, :request_id => @request_id}
    ...
    it "redirects back" do
      ...
      response.should redirect_to('/reorder_steps/')
    end
  ...
  describe "#destroy_step_in_procedure" do
    it 'changes steps count and redirects to edit' do
      ...
      expect{delete :destroy_step_in_procedure, {id: @step1.id,
                                                 request_id: @request_id}
            }.to change(Step, :count).by(-1)
      response.should redirect_to(edit_procedure_path(@procedure))
    end
  ...
  it "#add_category" do
    ...
    response.should render_template(:partial => 'steps/_add_category')
  end

  it "#expand_procedure" do
    get :expand_procedure, {:id => @step1.id,
                            :request_id => @request_id}
    response.should render_template(:partial => 'steps/_expanded_procedure_for_reorder')
  end
  ...
  it "#update_server_selects" do
    ...
    get :update_server_selects, {:id => @step1.id,
                                 ...
                                 :format => 'js'}
    assigns(:selected_server_groups).should include(@server_group)
    assigns(:selected_servers).should include(@server)
  end
  ...
  it "#toggle_execution" do
    ...
    @step1.reload
    @step1.name.should eql("toggle_changed_name")
  end
  ...
  it "#server_properties" do
    ...
    assigns(:server_aspects).should include(@server_aspect)
    assigns(:properties).should match_array(@server_level.properties)
  end
  ...
  context "#edit_execution_condition" do
    context 'not authorized' do
      ...
      it 'redirects to root path' do
        get :edit_execution_condition, {:id => @step1.id, :request_id => @request_id}
    ...
    it "returns condition_type 'property'" do
      get :edit_execution_condition, {:id => @step1.id,
                                      :request_id => @request_id}
      assigns(:condition_type).should eql('property')
      response.should render_template('edit_execution_condition')
    end
    ...
    it "returns step execution condition" do
      ...
      get :edit_execution_condition, {:id => @step2.id,
                                      :request_id => @request_id}
      assigns(:condition_type).should eql('environments')
    end
  end
  ...
  context "#run_now" do
    it "returns flash notice 'undefined method'" do
      put :run_now, {:id => "-1",
                     :request_id => @request_id}
      flash[:notice].should include('undefined method')
    end
  ...
  context "#runtime_phases_options" do
    ...
    specify "with execution_condition" do
      ...
      response.body.should include(@runtime_phase.name)
    end
  ...
  it "#environment_types_options" do
    ...
    get :environment_types_options, {:id => @step1.id,
                                     :request_id => @request_id}
    response.body.should include(@env_type.name)
  end
  ...
  context "#get_alternate_servers" do
    ...
    it "returns step servers associations" do
      ...
      response.should render_template(:partial => 'steps/_alternate_server_property_values')
    end
  ...
  describe "#bulk_update" do
    context 'not authorized' do
      context 'when can not delete steps' do
        ...
        it 'redirects to root path' do
          get :bulk_update, {:request_id => @request_id,
                           :step_ids => [@step1.id],
                           :apply_action => 'delete',
    ...
    context "request steps" do
      it "renders template bulk update" do
        get :bulk_update, {:request_id => @request_id,
                           :step_ids => [@step1.id],
                           :operation => "modify_assignment"}
        response.should render_template("steps/bulk_update", :layout => false)
      end
      ...
      it "delete step execution condition" do
        ...
        expect{delete :bulk_update, {:request_id => @request_id,
                                     :step_ids => [@step1.id],
                                     :apply_action => "delete"}
      ...
      it 'modify should execute' do
        get :bulk_update, {request_id: @request_id,
                           ...
                           step: {should_execute: 'true'}}
        @step1.reload
        @step1.should_execute.should be_truthy
      end
      ...
      it "update installed component" do
        ...
        get :bulk_update, {:request_id => @request_id,
                           ...
                           :step => {:should_execute => true,
                                     :component_id => @component.id}}
        @step1.reload
        @step1.server_ids.should include(@server.id)
      end
    ...
    context "bulk_update_procedure_steps" do
      ...
      it "deletes steps" do
        expect{delete :bulk_update, {:request_id => '-1',
                                     :step_ids => [@step2.id],
                                     :apply_action => "delete",
                                     :format => 'js'}
              }.to change(Step, :count).by(-1)
      ...
      it 'modify should execute' do
        ...
        get :bulk_update, {request_id: '-1',
                           ...
                           format: 'js'}
        @step2.reload
        @step2.should_execute.should be_truthy
        response.should render_template('steps/render_steps')
      end
      ...
      it "updates server ids" do
        ...
        get :bulk_update, {:request_id => '-1',
                           ...
                           :step => {:should_execute => 'true',
                                     :component_id => @component.id}}
        @step2.server_ids.should include(@server.id)
      end
  ...
  context "#step_component_options" do
    ...
    it "returns blank options" do
      get :step_component_options, {:id => @step1.id}
      response.body.should eql("<option value=''>Select</option>")
    end
  end
  ...
  context "#can_delete_step" do
    ...
    it "renders text 'step is used in procedure'" do
      ...
      @step2.create_execution_condition(:condition_type => "property",
                                        ...
                                        :value => @property_value.value,
                                        :property_id => @property.id)
      get :can_delete_step, {:request_id => @request_id, :id => @step1.id}
      response.body.should include('Step is used in procedure')
    end

    it "renders test 'Are you sure'" do
      get :can_delete_step, {:request_id => @request_id, :id => @step2.id}
      response.body.should include('you want to delete')
    end
  end

  it "#estimate_calculation" do
    get :estimate_calculation, {:request_id => @request_id,
                                :c_d => '02/03/2013 05:06 AM',

                                :s_d => '02/04/2013 05:06 AM'}
    response.body.should include('24,0')
  end
