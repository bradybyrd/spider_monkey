...
describe ApplicationComponentsController, type: :controller do
  ...
  it '#index' do
    ...
    expect(response).to render_template(partial: 'apps/_application_component_list')
  end
  ...
  it '#update' do
    ...
    expect(@app.application_components.find(@app_component.id).insertion_point).to eq 2
  end

  it '#add_remove' do
    get :add_remove, {app_id: @app.id}
    expect(response).to render_template(partial: 'application_components/_add_remove')
  end
  ...
  it '#setup_clone_components' do
    ...
    expect(response).to render_template(partial: 'apps/_clone_components')
  end
  ...
  context '#update_all' do
    ...
    it 'success with steps' do
      ...
      expect(response).to render_template('application_components/_add_remove')
    end
  end
  ...
  it '#add_component_mapping' do
    get :add_component_mapping, { app_id: @app.id,
                                  id: @app_component.id }
    expect(response).to render_template(partial: 'component_mappings/_add_component_mapping')
  end
  ...
  it '#resource_automations' do
    ...
    get :resource_automations, { app_id: @app.id,
                                 ...
                                 edit_mode: 'true'}
    expect(response).to render_template(partial: 'component_mappings/_resource_automations')
  end
  ...
  context '#filter_arguments' do
    it 'returns flash \'no script\'' do
      ...
      expect(flash.now[:error]).to include('Unable to find component mappings')
    end
    ...
    it 'finds script by id and renders partial' do
      ...
      get :filter_arguments, { app_id: @app.id,
                               ...
                               project_server_id: @pr_server.id,
                               script_id: @script.id}
      expect(response).to render_template(partial: 'component_mappings/_filter_arguments')
    end
  end
  ...
  context '#save_mapping' do
    ...
    it 'updates current mapping' do
      ...
      put :save_mapping, { app_id: @app.id,
                           ...
                           argument: {@arguments[0] => 'val1',
                                      @arguments[1] => 'val2'},
                           format: 'js'}
      expect(@app_component.application_component_mappings.first.script_id).to eq @script.id
      expect(response).to render_template('misc/redirect')
    end
    ...
    it 'returns errors' do
      ...
      put :save_mapping, { app_id: @app.id,
                           ...
                           project_server_id: @pr_server.id,
                           script_id: @script.id,
                           "tree_renderer_#{@arguments[0].id}" => %w(val01 val02 val03),
                           format: 'js'}
  ...
  context '#edit_property_values' do
    ...
    it 'renders template edit_property_values' do
      ...
      expect(assigns(:app_environments)).to eq @app_environments
    ...
    it 'renders partial show_property' do
      ...
      get :edit_property_values, { app_id: @app.id,
                                   ...
                                   show_property: true }
      expect(response).to render_template(partial: 'application_components/_show_properties')
    end
    ...
    it 'renders partial edit_property' do
      ...
      get :edit_property_values, { app_id: @app.id,
                                   ...
                                   show_view: true }
      expect(response).to render_template(partial: 'application_components/_edit_property_values')
    end
    ...
    it 'renders partial application_components/add_property' do
      get :edit_property_values, { app_id: @app.id,
                                   id: @app_component.id,
                                   add_property: true }
      expect(response).to render_template(partial: 'application_components/_add_property')
    end
  end
  ...
  context '#update_property_values' do
    ...
    it 'renders template property_success_create' do
      put :update_property_values, { app_id: @app.id,
                                     ...
                                     format: 'js'}
      expect(response).to render_template('application_components/property_success_create')
    end
    ...
    it 'removes property' do
      expect{put :update_property_values, { app_id: @app.id,
                                            ...
                                            "property_values_#{@app_environment.id}" => {
                                                @property.id => @property_value.value },
                                            format: 'js' }
            }.to change(ComponentProperty, :count).by(-1)
      expect(response).to render_template('update_property_values')
    end
    ...
    it 'updates property' do
      put :update_property_values, { app_id: @app.id,
                                     ...
                                     format: 'js'}
      expect(@installed_component.current_property_values.find_by_property_id(@property.id).value).to eq 'new_value'
