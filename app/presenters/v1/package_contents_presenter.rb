...
# All Rights Reserved.
################################################################################
class V1::PackageContentsPresenter < V1::AbstractPresenter

  # creates a local accessor based on the passed symbol
  presents :package_contents
  ...
  def safe_attributes
    return [:id, :name, :abbreviation, :position, :archive_number, :archived_at, :created_at, :updated_at]
  end
