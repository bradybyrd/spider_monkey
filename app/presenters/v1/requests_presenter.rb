...
class V1::RequestsPresenter < V1::AbstractPresenter
  ...
  def safe_attributes
    return [:id, :name, :aasm_state, :created_at, :updated_at, :description, :wiki_url, :estimate, :rescheduled, :scheduled_at_date,
